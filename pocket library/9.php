...
?>
  <form id="f1" method="post" action="9.php">
      <input type="submit"name="insert" value="Insert Faculty">
      <input type="submit"name="update" value="Update Faculty">
      <input type="submit"name="delete" value="Delete Faculty"><br>
  </form>
  ...
  <?php
    if (isset($_POST['insert'])) {?>
       ...
       if(isset($_POST['fname'])&&isset($_POST['lname'])&&isset($_POST['fid'])&&isset($_POST['pc'])&&isset($_POST['nob'])){
        ...
        $c=$_POST['pc'];
        $n=$_POST['nob'];
       $sql = "INSERT INTO faculty(f_name,l_name,f_id,premium_content,number_of_books) VALUES ('$i','$n',$a,$c,$n)";
 ...
 <?php
    ...
    if (isset($_POST['delete'])) {?>
            <form method="post" action="11.php">
                <span>Enter faculty id to delete (**)</span>
                <input type="number" name="fid"><br>
                <span>Enter first name</span>
                <input type="text" name="fname"><br>
...
echo "<h3>List of Faculty are</h3><br>";
?>
